...
**Цель:** Добавить в существующую конфигурацию HSRP отслеживание состояния "внутренних" интерфейсов `Gi0/0` для группы 1.
...
#### Команды, которые предполагалось использовать:
